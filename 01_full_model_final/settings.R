...
dem_path <- paste0(out_path, buildr_data, 'DTM5m.tif')
...
channel_path <- paste0(out_path, buildr_data, 'river.shp')
...
## basin boundary
basin_path <- bound_path <- paste0(out_path, buildr_data, 'basin.shp')
...
lu_shp <- paste0(out_path, farmr_i_data, 'crops.shp') 
